    ...
    <div>
        ...
        <Card className={classes.root}>
          <Card>
            <CardContent>
              ...
              <Typography>Person 4</Typography>
              <Typography>Person 5</Typography>
            </CardContent>
          </Card>
      ...
      <div className={questionclasses.root}>
        <Typography variant="h5" gutterBottom className={spaceclasses.root}>
          ...
          <Button variant="outlined" color="primary">
            {' '}
            {/* Needs to go to the next song, need to right the code to do that  */}
            Next
          </Button>
        </Typography>
      </div>
      ...
      <div className={optionclasses.root}>
        <Button
          variant="outlined"
          color="primary"
          className={spaceOptClasses.root}
        >

    ...
    return(
        <div className="about">
            <div className="about-header">
                <div>
                    <img className="about-musicLogo" src='https://lh3.googleusercontent.com/-CjiJG_t9Yhs/Xl6uR6LH7_I/AAAAAAAAAFA/bWVc5Bhb7wUdLXa2zr70HrpI_ccqeB6xwCK8BGAsYHg/s0/2020-03-03.png' alt="logo" />
                </div>
